...
//    }
    ...
    if ($validation['valid'] == TRUE) {
        $sql = "INSERT INTO `farmers` ( `f_no` ,`f_id` , `f_name` , `f_locality` ,  `f_ac` ,  `f_phone`  ) VALUES(  '{$_POST['f_no']}' ,'{$_POST['f_id']}' , '{$_POST['f_name']}' , '{$_POST['f_locality']}' ,  '{$_POST['f_ac']}' ,  '{$_POST['f_phone']}'  ) ";
...
<?php echo $validation['id'] ?>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input class="input-xlarge" type="text" placeholder="Location" name='f_locality'/> 
        </div>
    </div>
    <div class="control-group">
