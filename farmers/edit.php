...
//if (isset($_GET['edit']) && isset($_GET['id'])) {
    ...
    if (isset($_POST['f_no'])) {
        // 
       $validation= validate_farmers($_POST['f_no'], $_POST['f_id'], $_POST['f_name'], $_POST['f_locality'], $_POST['f_ac'], $_POST['f_phone'],$conn);
          if ($validation['valid']==TRUE ) {
              $sql = "UPDATE farmers SET  f_no =  '{$_POST['f_no']}' ,f_id =  '{$_POST['f_id']}' ,  f_name =  '{$_POST['f_name']}' , f_locality =  '{$_POST['f_locality']}' ,  f_ac =  '{$_POST['f_ac']}' ,  f_phone =  '{$_POST['f_phone']}'   WHERE f_no = '$f_no' ";
...
<a href='index.php' class='btn btn-primary'>Back To Listing</a>
    <form action='' method='POST' class="form-horizontal"> 
        ...
        <div class="control-group">
            <label class="control-label" for="f_locality"> Locality of Farmer:</label >
            <div class="controls">
                <input class="input-xlarge" type="text" placeholder="Area-X.." name='f_locality' value='<?php echo stripslashes($row['f_locality']) ?>'/> 
            </div>
        </div>
        <div class="control-group">
