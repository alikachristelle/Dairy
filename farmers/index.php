...
?> 
<?php 
// Display the "Add Farmer" button only if the user is not a Clerk
if ($current_user['role'] != 'Clerk') {
    echo '<a class="btn btn-large btn-primary" href="add.php"><i class="icon-plus icon-white"></i>Add Farmer</a><br/><br/>';
}
?>
